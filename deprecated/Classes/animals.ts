...
export class Convert {
  public static toIntCarpetas(json: string): IntCarpetas[] {
    return JSON.parse(json);
  }

  public static intCarpetasToJson(value: IntCarpetas[]): string {
    return JSON.stringify(value);
  }

  public static toIntCarpeta(json: string): IntCarpetas {
    return JSON.parse(json);
  }

  public static intCarpetaToJson(value: IntCarpetas): string {
    return JSON.stringify(value);
  }
