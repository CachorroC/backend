...
const fullfiledActuacionesMap: unknown[] = [];

const fullfiledActuacionesWRMap: unknown[] = [];

const noFullfiledActuacionesWRMap: unknown[] = [];

const notFullfiledActuacionesMap: unknown[] = [];

const fullfiledActuaciones: unknown[] = [];

const fullfiledActuacionesWR: unknown[] = [];

const noFullfiledActuacionesWR: unknown[] = [];

const notFullfiledActuaciones: unknown[] = [];

const reqOk: unknown[] = [];

const reqOkWR: unknown[] = [];

const reqNoOk: unknown[] = [];

const reqNoOkWR: unknown[] = [];

const reqOknoActuaciones: unknown[] = [];

const reqOknoActuacionesWR: unknown[] = [];

const reqOkHasActuaciones: unknown[] = [];

const reqOkHasActuacionesWR: unknown[] = [];

const rawReq: unknown[] = [];

const rawReqWR: unknown[] = [];
...
const fetchActuacioneswithreturn = async (
  idProceso: number, iOfA: string
) => {
  fs.mkdir (
    `src/json/out/actuaciones/${ idProceso }`,
