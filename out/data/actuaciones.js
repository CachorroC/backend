...
const fetchActuaciones = (
  ...
  function* () {
    fs.mkdir(
      `src/json/out/actuaciones/${idProceso}`,
      { recursive: true }
    );
    const req = yield fetch(
      `https://consultaprocesos.ramajudicial.gov.co:448/api/v2/Proceso/Actuaciones/${idProceso}`
...
<<<<<<< HEAD
        const hasNoActuaciones = Object.assign(Object.assign({}, res), {
          idProceso: idProceso,
          iOfA: iOfA,
        });
      ...
      if (actuaciones.length > 0) {
        const hasActuaciones = Object.assign(Object.assign({}, res), {
          idProceso: idProceso,
          iOfA: iOfA,
        });
    ...
    if (req.body) {
      const request = Object.assign(Object.assign({}, req.body), {
        idProceso: idProceso,
        iOfA: iOfA,
      });
      reqOk.push(request);
      fs.writeFile(
        ...
        JSON.stringify(reqOk)
=======
        const hasNoActuaciones = Object.assign(
          Object.assign(
            {},
            res
          ),
      ...
      if (actuaciones.length > 0) {
        const hasActuaciones = Object.assign(
          Object.assign(
            {},
            res
          ),
...
const fetchActuacioneswithreturn = (
  idProceso, iOfA
) => __awaiter(
  void 0,
  void 0,
...
=======
        ...
        reqOknoActuacionesWR.push(
          hasNoActuaciones
        );
        fs.writeFile(
          `src/json/out/actuaciones/${idProceso}/WR.reqOknoActuaciones.actuaciones.json`,
          JSON.stringify(
            reqOknoActuacionesWR
          )
>>>>>>> 2e92fe5 (Signed-off-by: CachorroC <juankpato87@gmail.com>)
        );
...
=======
        reqOkHasActuacionesWR.push(
          hasActuaciones
        );
        fs.writeFile(
          `src/json/out/actuaciones/${idProceso}/WR.reqOkhasActuaciones.actuaciones.json`,
          JSON.stringify(
            reqOkHasActuacionesWR
          )
        );
        return hasActuaciones;
      }
...
const forEachProceso = procesos.forEach((proceso, index, procArr) => {
  ...
  setTimeout(() => {
    ...
    fetchActuaciones(idProceso, iOfA).then(
      (fullfiled) => {
        const onFullfiled = {
          fullfiled: fullfiled,
          idProceso: idProceso,
      ...
      (err) => {
        ...
        const notFullfiled = Object.assign(Object.assign({}, err), {
          idProceso: idProceso,
          iOfA: iOfA,
        });
    ...
    fetchActuacioneswithreturn(idProceso, iOfA).then(
      (ff) => {
        const onFullfiledwr = Object.assign(Object.assign({}, ff), {
          idProceso: idProceso,
          iOfA: iOfA,
        });
      ...
      (err) => {
        console.log(JSON.stringify(err));
        const notFullfiledwr = Object.assign(Object.assign({}, err), {
          idProceso: idProceso,
          iOfA: iOfA,
        });
...
const messyMap = procesos.map((proceso, index, array) => {
  ...
  return fetchActuacioneswithreturn(idProceso, iOfA).then(
    (ff) => {
      const onFullfiledwr = Object.assign(Object.assign({}, ff), {
        idProceso: idProceso,
        iOfA: iOfA,
      ...
      () => {
        ...
        fetchActuaciones(
          ...
          (
            ...
            fullfiledActuaciones.push(
              onFullfiled
            );
            fs.writeFile(
              'src/json/out/actuaciones/fullfiled.actuaciones.json',
              JSON.stringify(
                fullfiledActuaciones
              )
            );
          },
          (
            ...
            const notFullfiled = Object.assign(
              Object.assign(
                {},
                err
              ),
            ...
            notFullfiledActuaciones.push(
              notFullfiled
            );
            fs.writeFile(
              'src/json/out/actuaciones/notFullfiled.actuaciones.json',
              JSON.stringify(
                notFullfiledActuaciones
              )
            );
          }
        );
        fetchActuacioneswithreturn(
          idProceso,
          iOfA
        ).then(
          (
            ...
            const onFullfiledwr = Object.assign(
              Object.assign(
                {},
                ff
              ),
            ...
            fullfiledActuacionesWR.push(
              onFullfiledwr
            );
            fs.writeFile(
              'src/json/out/actuaciones/WRfullfiled.actuaciones.json',
              JSON.stringify(
                fullfiledActuacionesWR
              )
            );
            return onFullfiledwr;
          },
          (
            ...
            const notFullfiledwr = Object.assign(
              Object.assign(
                {},
                err
              ),
            ...
            noFullfiledActuacionesWR.push(
              notFullfiledwr
            );
            fs.writeFile(
              'src/json/out/actuaciones/WRnotFullfiled.actuaciones.json',
              JSON.stringify(
                noFullfiledActuacionesWR
              )
            );
            return notFullfiledwr;
          }
  ...
  (
    ...
    fetchActuaciones(
      ...
      (
        ...
        fullfiledActuacionesMap.push(
          onFullfiled
        );
        fs.writeFile(
          'src/json/out/actuaciones/fullfiled.Map.actuaciones.json',
          JSON.stringify(
            fullfiledActuacionesMap
          )
        );
      },
      (
        ...
        notFullfiledActuacionesMap.push(
          notFullfiled
        );
        fs.writeFile(
          'src/json/out/actuaciones/notFullfiled.Map.actuaciones.json',
          JSON.stringify(
            notFullfiledActuacionesMap
          )
        );
      }
    );
    return fetchActuacioneswithreturn(
      idProceso,
      iOfA
    ).then(
      (
        ...
        fullfiledActuacionesWRMap.push(
          onFullfiledwr
        );
        fs.writeFile(
          'src/json/out/actuaciones/WRfullfiled.Map.actuaciones.json',
          JSON.stringify(
            fullfiledActuacionesWRMap
          )
        );
        return onFullfiledwr;
      },
      (
        ...
        noFullfiledActuacionesWRMap.push(
          notFullfiledwr
        );
        fs.writeFile(
          'src/json/out/actuaciones/notFullfiledWR.Map.actuaciones.json',
          JSON.stringify(
            noFullfiledActuacionesWRMap
          )
        );
        return notFullfiledwr;
      }
