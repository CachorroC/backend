...
const fetchActuaciones = (idProceso, iOfA) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!req.ok) {
        ...
        fs.appendFile(`src/json/out/actuaciones/${idProceso}/reqNoOk.actuaciones.json`, JSON.stringify(errorMaker));
    }
    if (req.ok) {
        ...
        if (actuaciones.length === 0) {
            ...
            fs.appendFile(`src/json/out/actuaciones/${idProceso}/reqOkhasNoActuaciones.actuaciones.json`, JSON.stringify(hasNoActuaciones));
        }
        if (actuaciones.length > 0) {
            const hasActuaciones = Object.assign(Object.assign({}, res), { idProceso: idProceso, iOfA: iOfA });
            fs.appendFile(`src/json/out/actuaciones/${idProceso}/reqOkhasActuaciones.actuaciones.json`, JSON.stringify(hasActuaciones));
        }
        const requestOk = Object.assign(Object.assign({}, res), { idProceso: idProceso, iOfA: iOfA });
        fs.appendFile(`src/json/out/actuaciones/${idProceso}/reqOk.actuaciones.json`, JSON.stringify(requestOk));
    }
    if (req.body) {
        const request = Object.assign(Object.assign({}, req.body), { idProceso: idProceso, iOfA: iOfA });
        fs.appendFile(`src/json/out/actuaciones/${idProceso}/request.actuaciones.json`, JSON.stringify(request));
    }
    const request = {
        idProceso: idProceso,
        iOfA: iOfA,
...
const fetchActuacioneswithreturn = (idProceso, iOfA) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!req.ok) {
        ...
        fs.appendFile(`src/json/out/actuaciones/${idProceso}/WRreqNoOk.actuaciones.json`, JSON.stringify(errorMaker));
        return errorMaker;
    }
    if (req.ok) {
        const res = yield req.json();
        ...
        if (actuaciones.length === 0) {
            const hasNoActuaciones = Object.assign(Object.assign({}, res), { idProceso: idProceso, iOfA: iOfA });
            fs.appendFile(`src/json/out/actuaciones/${idProceso}/WRreqOkhasNoActuaciones.actuaciones.json`, JSON.stringify(hasNoActuaciones));
        ...
        if (actuaciones.length > 0) {
            ...
            fs.appendFile(`src/json/out/actuaciones/${idProceso}/WRreqOkhasActuaciones.actuaciones.json`, JSON.stringify(hasActuaciones));
            return hasActuaciones;
        }
        const requestOk = Object.assign(Object.assign({}, res), { idProceso: idProceso, iOfA: iOfA });
        fs.appendFile(`src/json/out/actuaciones/${idProceso}/WRreqOk.actuaciones.json`, JSON.stringify(requestOk));
        return requestOk;
    }
    if (req.body) {
        const request = Object.assign(Object.assign({}, req.body), { idProceso: idProceso, iOfA: iOfA });
        fs.appendFile(`src/json/out/actuaciones/${idProceso}/WRrequest.actuaciones.json`, JSON.stringify(request));
        return request;
    }
    const request = {
        idProceso: idProceso,
...
const forEachProceso = procesos.forEach((proceso, index, procArr) => {
    ...
    setTimeout(() => {
        ...
        fetchActuaciones(idProceso, iOfA).then((fullfiled) => {
            ...
            fs.appendFile('src/json/out/actuaciones/fullfiled.actuaciones.json', JSON.stringify(fullfiledActuaciones));
        }, (err) => {
            ...
            fs.appendFile('src/json/out/actuaciones/notFullfiled.actuaciones.json', JSON.stringify(notFullfiledActuaciones));
        });
        fetchActuacioneswithreturn(idProceso, iOfA).then((ff) => {
            ...
            fs.appendFile('src/json/out/actuaciones/WRfullfiled.actuaciones.json', JSON.stringify(fullfiledActuacionesWR));
            ...
            fs.appendFile('src/json/out/actuaciones/WRnotFullfiled.actuaciones.json', JSON.stringify(noFullfiledActuacionesWR));
...
const messyMap = procesos.map((proceso, index, array) => {
    ...
    fetchActuaciones(idProceso, iOfA).then((fullfiled) => {
        ...
        fs.appendFile('src/json/out/actuaciones/fullfiled.Map.actuaciones.json', JSON.stringify(fullfiledActuacionesMap));
    }, (err) => {
        console.log(JSON.stringify(err));
        const notFullfiled = Object.assign(Object.assign({}, err), { idProceso: idProceso, iOfA: iOfA });
        notFullfiledActuacionesMap.push(notFullfiled);
        fs.appendFile('src/json/out/actuaciones/notFullfiled.Map.actuaciones.json', JSON.stringify(notFullfiledActuacionesMap));
    });
    return fetchActuacioneswithreturn(idProceso, iOfA).then((ff) => {
        const onFullfiledwr = Object.assign(Object.assign({}, ff), { idProceso: idProceso, iOfA: iOfA });
        fullfiledActuacionesWRMap.push(onFullfiledwr);
        fs.appendFile('src/json/out/actuaciones/WRfullfiled.Map.actuaciones.json', JSON.stringify(fullfiledActuacionesWRMap));
        return onFullfiledwr;
    }, (err) => {
        console.log(JSON.stringify(err));
        const notFullfiledwr = Object.assign(Object.assign({}, err), { idProceso: idProceso, iOfA: iOfA });
        noFullfiledActuacionesWRMap.push(notFullfiledwr);
        fs.appendFile('src/json/out/actuaciones/notFullfiledWR.Map.actuaciones.json', JSON.stringify(noFullfiledActuacionesWRMap));
        return notFullfiledwr;
    });
});
messyMap;
