...
const fetchActuaciones = (idProceso, iOfA) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!req.ok) {
      ...
      error.push(res);
      fs.writeFile(
        `src/json/out/actuaciones/${idProceso}/error.actuaciones.json`,
  ...
  setTimeout(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        const acts = yield fetchActuaciones(idProceso, iOfA);
        const helper = {
          acts: acts,
          idProceso: idProceso,
          iOfA: iOfA,
        ...
        helpers.push(helper);
        fs.writeFile(
          `src/json/out/actuaciones/${idProceso}/helper.actuaciones.json`,
          JSON.stringify(helper)
        );
        fs.writeFile(
          `src/json/out/actuaciones/${idProceso}/HelperS.actuaciones.json`,
