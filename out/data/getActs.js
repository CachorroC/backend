...
const fetchActuaciones = (idProceso, iOfA) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!req.ok) {
        ...
        console.log(res);
        error.push(res);
        fs.writeFile(`src/json/out/actuaciones/${iOfA}.error.actuaciones.json`, JSON.stringify(error));
        return res;
    }
    if (req.ok) {
    ...
    rawReq.push(request);
    fs.writeFile('src/json/out/actuaciones/rawRequest.actuaciones.json', JSON.stringify(rawReq));
    const bb = {
        acts: res.actuaciones,
        idProceso: idProceso,
        iOfA: iOfA,
...
const forEachProceso = procesos.forEach((proceso, index, procArr) => {
    ...
    setTimeout(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        helpers.push(helper);
        fs.writeFile(`src/json/out/actuaciones/${iOfA}.helper.actuaciones.json`, JSON.stringify(helper));
        fs.writeFile(`src/json/out/actuaciones/${iOfA}.HelperS.actuaciones.json`, JSON.stringify(helpers));
    }), index * 1000);
});
