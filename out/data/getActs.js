...
fs.mkdir("src/json/out/actuaciones", { recursive: true });
  ...
  setTimeout(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        const helper = yield fetchActuaciones(idProceso, iOfA);
        helpers.push(helper);
        fs.writeFile(
  ...
  (
    ...
    setTimeout(
      () => __awaiter(
        ...
        function* () {
          const idProceso = proceso.idProceso;
          const helper = yield fetchActuaciones(
            idProceso,
            iOfA
          );
          helpers.push(
...
>>>>>>> 2e92fe5 (Signed-off-by: CachorroC <juankpato87@gmail.com>)
forEachProceso;
//# sourceMappingURL=getActs.js.map
