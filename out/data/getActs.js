...
const fetchActuaciones = (idProceso, iOfA) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    rawReq.push(request);
    fs.writeFile(`src/json/out/actuaciones/${iOfA}.Request.actuaciones.json`, JSON.stringify(request));
    fs.writeFile(`src/json/out/actuaciones/${iOfA}.rawRequest.actuaciones.json`, JSON.stringify(rawReq));
    const bb = {
