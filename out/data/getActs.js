...
const fetchActuaciones = (idProceso, iOfA) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!req.ok) {
        ...
        error.push(res);
        fs.writeFile('src/error,json', JSON.stringify(error));
    }
    ...
    rawReq.push(request);
    fs.writeFile(`src/json/out/actuaciones/${idProceso}/Request.actuaciones.json`, JSON.stringify(request));
...
const forEachProceso = procesos.forEach((proceso, index, procArr) => {
    ...
    setTimeout(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        helpers.push(helper);
        fs.writeFile(`src/json/out/actuaciones/${idProceso}/helper.actuaciones.json`, JSON.stringify(helper));
        fs.writeFile('src/helpers.actuaciones.json', JSON.stringify(helpers));
    }), index * 1000);
});
