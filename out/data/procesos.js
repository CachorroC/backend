...
exports.fetchConsultaNumeroRadicacionfromRama = exports.fetchProcesoRama =
    void 0;
...
function fetchProcesoRama(llaveProceso, iOfA) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!req.ok) {
            ...
            const errorMaker = Object.assign(Object.assign({}, req), {
                error: err,
        ...
        if (req.ok) {
            if (res.procesos.length === 0) {
                ...
                fs.writeFile(
                    ...
                    JSON.stringify(notFullfilledFetch)
                );
...
exports.fetchConsultaNumeroRadicacionfromRama = procesos.forEach(
    (llaveProceso, index, array) => {
        ...
        setTimeout(() => {
            fetchProcesoRama(llaveProceso, iOfA).then(
                (CNR) => {
                    ConsultaNumeroRadicacion.push(
                        Object.assign(Object.assign({}, CNR), {
                            llaveProceso: llaveProceso,
                            iOfA: iOfA,
                        })
                    );
