...
const rows_1 = __importDefault(require("#@/data/rows"));
exports.cleanProcesos = rows_1.default.flatMap((radicado) => {
  console.log(rows_1.default);
...
const rows_js_1 = __importDefault(
  require(
    '../data/rows.js'
  )
);
exports.cleanProcesos = rows_js_1.default.flatMap(
  (
    radicado
  ) => {
    console.log(
...
exports.fixDemandado = fixDemandado;
exports.Procesos = exports.cleanProcesos.map(
  (
    proceso
  ) => {
    const Proceso = {
