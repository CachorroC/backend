...
import { intActuacion } from '../../../app/src/types/procesos';
...
const rawReq: { res: intConsultaActuaciones; idProceso: number; iOfA: string; }[]= [];
...
const fetchActuaciones = async (
    ...
    fs.writeFile(
        'src/json/out/actuaciones/rawRequest.actuaciones.json',
        JSON.stringify(
            rawReq
        )
    );
